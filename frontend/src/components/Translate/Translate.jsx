          ...
          <div className="w-full">
            ...
            <div className="flex flex-col lg:flex-row mx-auto bg-white drop-shadow-2xl rounded-lg">
              <div className="w-full lg:w-1/3 px-12 flex flex-col items-center py-10">
                ...
                <h2 className="text-indigo-800 text-2xl tracking-normal font-semibold mb-1">
                  SADS Translator
                </h2>
                ...
                <p className="text-gray-600 text-sm tracking-normal font-normal mb-8 text-center w-10/12">
                  Here is the translate API, select the languages. Type the
                  input and then voila translated!
                </p>
                ...
                <select
                  inputId="outputLang"
                  className="mt-4 block w-full text-gray-700 py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500"
                  name="Input Language"
                >
                ...
                <button
                  type="button"
                  className="py-2 px-4 mt-4 bg-indigo-200 hover:bg-indigo-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg "
                >
                  Detect Language
                </button>
                <button
              ...
              <div className="w-full lg:w-1/3 flex-col flex justify-center items-center px-12 py-8">
                ...
                <label className="text-gray-700" htmlFor="name">
                  <textarea
                    className="flex-1 border border-gray-300 w-full py-2 px-4 bg-white text-xl text-gray-700 placeholder-gray-400 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-indigo-800 focus:border-transparent"
                    id="input"
